    ...
    setTimeout(function() {
        ...
        function format(d) {
            return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">' +
                ...
                '</tr>' +
                '<tr>' +
                '<td class="align-middle">Extension number:</td>' +
                '<td class="align-middle">' + d.extn + '</td>' +
                '</tr>' +
                '<tr>' +
                '<td class="align-middle">Extra info:</td>' +
                '<td class="align-middle">And any further details here (images etc)...</td>' +
                '</tr>' +
                '</table>';
        }
